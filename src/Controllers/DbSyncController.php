...
class DbSyncController extends Controller
{
    ...
    public function blockHashes(): ResponseInterface
    {
        ...
        if (! in_array($table, ['users', 'settings'], true) && ! array_key_exists($table, DbSyncSchema::genericTables()) && ! array_key_exists($table, DbSyncSchema::genericIdBasedTables()) && ! array_key_exists($table, DbSyncSchema::genericCompositeKeyTables())) {
