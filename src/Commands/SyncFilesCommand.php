 ...
 * manifest, not a live comparison against every peer - that's a
 * separate, heavier "realignment" mechanism, see Commands\RealignCommand),
 * and queues one PushFileJob per changed file per public peer.
 *
