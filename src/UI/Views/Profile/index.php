    ...
    <div class="col-12 col-md-6">
        <div class="card">
            <div class="card-body" id="profile-form"
                 data-endpoint="<?= url_to('profile.updateField') ?>"
                 data-avatar-endpoint="<?= url_to('profile.uploadAvatar') ?>">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-2 <?= empty($profile['avatar']) ? 'd-none' : '' ?>" id="avatar-thumb-wrap">
                        ...
                        <span class="badge bg-red-lt" id="avatar-delete-btn" style="cursor:pointer" data-endpoint="<?= url_to('profile.deleteAvatar') ?>"><?= lang('App.delete') ?></span>
                    </div>
