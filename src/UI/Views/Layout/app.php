                ...
                <div class="navbar-nav flex-row order-md-last align-items-center">
                    ...
                    <div class="dropdown me-3">
                        <a href="#" class="nav-link px-0" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="<?= base_url(AdGo\Cluster\UI\Config\Locales::flagImage(service('request')->getLocale())) ?>" width="22" alt="">
                        </a>
                            ...
                            <?php foreach (config('App')->supportedLocales as $locale) : ?>
                                <form method="post" action="<?= url_to('locale.update') ?>" class="d-inline">
                                    ...
                                    <button type="submit" class="dropdown-item d-flex align-items-center gap-2 <?= service('request')->getLocale() === $locale ? 'active' : '' ?>">
                                        <img src="<?= base_url(AdGo\Cluster\UI\Config\Locales::flagImage($locale)) ?>" width="18" alt="">
                                        <span><?= esc(AdGo\Cluster\UI\Config\Locales::label($locale)) ?></span>
                                    </button>
                                </form>
                            <?php endforeach ?>
                        </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            <a href="<?= url_to('profile') ?>" class="dropdown-item"><?= lang('App.profile') ?></a>
            ...
            <?php if (auth()->user()) : ?>
                ...
                <ul class="nav flex-column pt-3">
                    <?php if (auth()->user()->inGroup('superadmin')) : ?>
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2<?= strpos($currentPath, 'users') === 0 ? ' active' : '' ?>" href="<?= url_to('users') ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2<?= strpos($currentPath, 'settings') === 0 ? ' active' : '' ?>" href="<?= url_to('settings') ?>">
