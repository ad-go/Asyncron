...
use AdGo\Cluster\UI\Models\UserProfileModel;
...
class ProfileController extends BaseController
{
    public function index(): string
    {
        ...
        // Not the bare 'Profile/index' - see AuthController::logoutView()'s
        // own docblock for why a name with no backslash in it can never
        // resolve outside the consuming app's own (empty) app/Views/.
        return view('\AdGo\Cluster\UI\Views\Profile\index', ['user' => auth()->user(), 'profile' => $profile] + $this->layoutData());
    }
