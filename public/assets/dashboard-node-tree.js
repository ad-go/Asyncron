(function () {
    ...
    // See dashboard-network.js's own humanSize() (loaded before this script
    // in dashboard.php) - shared via window rather than redefined here.
    var humanSize = window.humanSize;
